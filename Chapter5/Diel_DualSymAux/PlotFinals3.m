...
for LL = [10,18]
    load(strcat('DielectricCurve3Len',num2str(LL),'.mat'))
    choice = [1,size(pp,3)];
...
%     plot3(X(1,:),X(2,:),X(3,:),'-','LineWidth', 1,'Color','b', 'LineWidth', 2.5)
    ...
    text(5.243185371794539,2.938439325900731,8.137703327712416,...%-11.321749505059643,37.301436888059925,435.9649565850114,...
    ...
    text(6.210397772149577,-10.103747126292944,-1.779889660749063, {...
        ...
        filename=strcat("ThesisPlots/3IteratesU",num2str(LL),num2str(kk));
