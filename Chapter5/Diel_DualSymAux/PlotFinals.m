...
for LL = [4,8]
    load(strcat('DielectricCurve1Len',num2str(LL),'.mat'))
    choice = [1,size(pp,3)];
    for kk = 1: length(choice)
        ...
        text(3.045109305040029,1.869453602902468,4.351115568611363,...%-11.321749505059643,37.301436888059925,435.9649565850114,...
        ...
        filename=strcat("ThesisPlots/1IteratesI",num2str(LL),num2str(kk));
