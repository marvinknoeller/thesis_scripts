...
#
filename = 'runtime_information_ring_metal_21.txt'
...
for x in radii:
    name_of_ff = os.path.join('farfields/ring', 'farFieldring_new21'+x+'.mat')
    name_of_mesh = os.path.join('grids/ring', 'Ring' + x + '.msh')
    ##
    with open(filename, 'a') as f:
