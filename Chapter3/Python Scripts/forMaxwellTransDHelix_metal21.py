...
for x in radii:
    name_of_ff = os.path.join('farfields/double_helix', 'farField_DHelixMetal21'+x+'.mat')
    name_of_mesh = os.path.join('grids/double_helix', 'Dhelix_new' + x + '.msh')
    ##
    with open(filename, 'a') as f:
