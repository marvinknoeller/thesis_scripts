...
rad_plot = horzcat(0.03:0.01:0.1,[0.12,0.14,0.16,0.18,0.2]);%,0.125,0.15,0.175,0.2,0.25,0.3:0.1:0.5);
radii = ["003","004","005","006","007","008","009","01","012","014","016","018","02"];
for number = 1:length(radii)
    name = strcat('farfields/dielectric/double_helix_farfields/farFieldDhelix_new',radii(number),'.mat');
    load(name)
    E_Bempp= FarField;%
    t=linspace(0,1,n);
    R=1;
