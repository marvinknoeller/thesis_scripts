...
hold all
plot3(ones(size(X(1,:)))*3,X(2,:),X(3,:),'-k', 'LineWidth', 2.5)
plot3(X(1,:),ones(size(X(2,:)))*3.001,X(3,:),'-k', 'LineWidth', 2.5)
plot3(X(1,:),X(2,:),ones(size(X(3,:)))*(-3),'-k', 'LineWidth', 2.5)
axis equal
axis([-1.,3.,-1.001,3.001,-3,1])
set(gca,'fontsize',14)
text(1.467154220946668,0.526461566439011,2.270401543639892,...
