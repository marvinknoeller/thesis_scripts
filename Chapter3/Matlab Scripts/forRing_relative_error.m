...
for number = 1:length(radii)
    name = strcat('farfields/dielectric/ring_farfields/farFieldring_new',radii(number),'.mat');
    load(name)
    E_Bempp= FarField;
    t=linspace(0,1,n);
    R=1;
...
text(0.065,0.006,"slope 2",'Interpreter','Latex','FontSize',20,'BackgroundColor', 'w','EdgeColor',...
    'k','LineWidth',1.)
axis square
filename='Ringplots/Plot1';
